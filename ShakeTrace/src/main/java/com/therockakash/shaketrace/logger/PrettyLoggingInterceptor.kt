...
class PrettyLoggingInterceptor private constructor(private val builder: Builder) : Interceptor {
    ...
    class Builder {
        ...
        fun setCashDir(dir: File): Builder {
            this.dir = dir
            return this
        }
        /**
        ...
        fun build(): PrettyLoggingInterceptor {
            return PrettyLoggingInterceptor(this)
        }
